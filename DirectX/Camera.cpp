...
void Camera::Update(float deltaSeconds)
{
	...
	if (pKeyboardState[SDL_SCANCODE_Q] || pKeyboardState[SDL_SCANCODE_RIGHT])
	{
		m_Origin += m_Up * movementSpeed * deltaSeconds;
	}
	if (pKeyboardState[SDL_SCANCODE_E] || pKeyboardState[SDL_SCANCODE_LEFT])
	{
		m_Origin -= m_Up * movementSpeed * deltaSeconds;
	}
